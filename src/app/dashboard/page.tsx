        ...
        <aside className="lg:w-[240px] shrink-0">
          <div className="bg-white dark:bg-[#0F172A] rounded-[20px] border border-[#E2E8F0] dark:border-[#1E293B] p-4 sticky top-[76px]">
            <div className="flex items-center gap-3 mb-4">
              <img src="https://i.pravatar.cc/100?img=68" alt="user" className="h-10 w-10 rounded-full" />
              <div><div className="font-bold text-sm dark:text-white">Fahad A.</div><div className="text-xs text-[#64748B] dark:text-[#94A3B8]">fahad@travgo.sa</div></div>
            </div>
