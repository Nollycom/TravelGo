    ...
    <div className="mx-auto max-w-[640px] px-4 py-10">
      <div className="bg-white dark:bg-[#0F172A] rounded-[20px] border border-[#E2E8F0] dark:border-[#1E293B] p-8 text-center">
        ...
        <div className="grid gap-3 mt-6">
          <a href="https://github.com/Nollycom/TravelGo/releases/download/v1.1.0/app-debug.apk" className="w-full h-12 rounded-full bg-[#0E7C6B] dark:bg-[#14B8A6] text-white font-bold flex items-center justify-center">⬇️ Télécharger APK v1.1.0 (GitHub - 9.73 MB)</a>
          <a href="https://github.com/Nollycom/TravelGo/releases/tag/v1.1.0" target="_blank" className="w-full h-11 rounded-full border border-[#E2E8F0] dark:border-[#1E293B] dark:text-white font-bold flex items-center justify-center">Voir la Release GitHub v1.1.0</a>
          <span className="text-xs text-[#64748B]">Dashboard temps réel + inscription agences/utilisateurs activée. APK aussi via travgo.web.app/download après passage Blaze/Storage.</span>
        </div>
